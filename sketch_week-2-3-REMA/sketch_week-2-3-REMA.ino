...
const char ssid[] = "Bilbo_Laggins";
//Contraseña de la red Wifi
const char pass[] = "JYD6139146";

//Usuario uniandes sin @uniandes.edu.co
#define HOSTNAME "d.herrerag"

//Conexión a Mosquitto
const char MQTT_HOST[] = "iotlab.virtual.uniandes.edu.co";
const int MQTT_PORT = 8082;
//Usuario uniandes sin @uniandes.edu.co
const char MQTT_USER[] = "d.herrerag";
//Contraseña de MQTT que recibió por correo
const char MQTT_PASS[] = "200922952";
...
//Tópico al que se enviarán los datos de iluminacion
...
void loop()
{
  ...
  float lightSensorValue = analogRead(light_raw);// gets the raw value from LDR

  float light = map(lightSensorValue, 16 ,1024, 0, 100);// Converts raw light value to percentage
  ...
  //JSON para iluminacion
  json = "{\"value\": "+ String(light) + "}";
  ...
  if ( !isnan(h) && !isnan(t) &&  !isnan(light) ) {
    ...
    //Publica en el tópico de la iluminacion
